  ...
  style.textContent = `
    ...
    * { box-sizing: border-box; }
    ...
    #fab {
      ...
      pointer-events: auto;
      opacity: 0.5; /* Semi-transparent when not hovered */
      user-select: none;
      touch-action: none;
    }
    #fab:hover { opacity: 1.0; background-color: #1f2937; transform: translateY(-50%) scale(1.05); }
    #fab:active { cursor: grabbing; }
    #fab img { width: 32px; height: 32px; object-fit: contain; pointer-events: none; }
